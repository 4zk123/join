...
//		Object userdo = redisCacheManager.getCache("yizhi_shiro_redis_session:b68cab0d-2238-4ab0-aed1-c70046ea0961");
//		System.out.println(userdo);
		System.out.println("保存："+studentInfoDO);
	...
	public PageUtils list(@RequestParam Map<String, Object> params){
		int currentPage = Integer.parseInt(params.get("currPage").toString());
		int pageSize = Integer.parseInt(params.get("pageSize").toString());
		currentPage = (currentPage - 1) * pageSize ;
		pageSize = currentPage + pageSize;
		params.put("currPage",currentPage);
		params.put("pageSize",pageSize);
		List<StudentInfoDO> page = studentInfoService.list(params);
		int total = studentInfoService.count(params);
		PageUtils pageUtils = new PageUtils(page,total,currentPage,pageSize);
		return pageUtils;
